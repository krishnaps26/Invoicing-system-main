<?php
            ...
            if($resc){
                ...
                while($rowc=mysqli_fetch_assoc($resc)){
                    ...
                    $pdf->SetProtection(array('print', 'copy','modify'), "k", "ourcodeworld-master", 0, null);
                    //for more permissions: https://ourcodeworld.com/articles/read/275/how-to-encrypt-a-pdf-password-protection-against-copy-extraction-or-modifications-generated-with-tcpdf-in-php
            ...
            <table>
            <tr>
            <td colspan="2">Invoice id: $inv_no</td>
            <td colspan="1">Date: 
            EOD
            .date("d-m-Y").
            ...
            <table border="1px" border-collapse="collapse" cellpadding="2" cellspacing="2" margin-top="5%">
            <tr>
              <th colspan="16" align="center"> INVOICE </th>
            </tr>
            <tr style="background-color: #FCF6F5">
              <th colspan="1" style="text-align: center;">Sr.no.</th>
              <th colspan="8" style="text-align: center;">Product Name</th>             
              ...
              <th colspan="3" style="text-align: center;">Net Am.</th>
            </tr>
            EOD;
            ...
            if($res=mysqli_query($conn,$sql)){
                ...
                $foo=(float)$price + (float)$price*(((float)$cgst+(float)$sgst)/100);
                $net=number_format((float)$foo, 2, '.', '');    
                $total=$total + $net;
                $tbl .=<<<EOD
            <tr>
            <th colspan="1" style="text-align: center;">$i</th>
              <th colspan="8">$pname</th>             
              <th colspan="2" style="text-align: center;">Rs. $price</th>
              <th colspan="1" style="text-align: center;">$cgst%</th>
              <th colspan="1" style="text-align: center;">$sgst%</th>
              <th colspan="3" style="text-align: center;">Rs. $net</th>
            ...
            <td  colspan="3" style="text-align:center; background-color: #FCF6F5">Rs. $total</td>
  ...
  $tbl .=<<<EOD
  <tr>
  <td colspan="13" style="text-align:left;">Amount payable:Rs. $total/-</td>
  </tr><tr>
