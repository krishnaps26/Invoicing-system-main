<?php
            ...
            <tr style="font-size: 40px; text-align: center; padding-bottom: 0;">
            <td style="width:100%"><img src="Untitled design.png" height="30" width="30">
            Waterstones</td>
            </tr>
            <tr><td style="width:100%" style="font-size: 15px; text-align: center; padding-top: 0;">Grow richer with each purchase</td></tr>
            <tr style="font-size: 11px;">
            <td style="width:35%; text-align: left;">Email: waterstonesbookclub@gmail.com</td>
            <td style="text-align: right; width:25%;">Telephone: 1234-5678</td>
            <td style="width:45%; text-align: right;">Website: https://www.waterstonesbookclub.com/</td>
            </tr>
            </table>
            <hr style="margin: 5px;">
            ...
            <table border="1px solid black" border-collapse="collapse" cellpadding="2" cellspacing="2" margin-top="5%">
            <tr>
            ...
            <tr style="background-color: ">
              ...
              <th colspan="1" style="text-align: center;">utgst%</th>
            ...
            if($res=mysqli_query($conn,$sql))
          {
                ...
                while($row=mysqli_fetch_assoc($res))
              {
                ...
                $tbl .=<<<EOD
            <tr>
            <th colspan="1" style="background-color: ; text-align: center;">$i</th>
              <th colspan="4"style="background-color: ;">$pname</th>             
              <th colspan="2" style="background-color: ; text-align: center;">Rs. $price</th>
              <th colspan="1" style="background-color: ; text-align: center;">$units</th>
              <th colspan="2" style="background-color: ; text-align: center;">Rs.$amt</th>
              <th colspan="1" style="background-color: ; text-align: center;">$cgst%</th>
              <th colspan="1" style="background-color: ; text-align: center;">$utgst%</th>
              <th colspan="1" style="background-color: ; text-align: center;">$sgst%</th>
              <th colspan="1" style="background-color: ; text-align: center;">$igst%</th>
              <th colspan="2" style="background-color: ; text-align: center;">Rs. $net</th>   
            </tr>
            EOD;
           ...
           if($i%$break==0){
              $tbl .=<<<EOD
              <tr>
              <td colspan="13" style="text-align:right;">Local total: </td>
              <td colspan="1" style="text-align:right;"></td>
              <td  colspan="2" style="text-align:center; background-color: ; margin-bottom:5px; padding-bottom:5px;">Rs. $total</td>
              </tr>
              </table>
              <br pagebreak="true" />
              <table border="1px solid black" border-collapse="collapse" cellpadding="2" cellspacing="2" margin-top="5%">
              <tr>
              <td colspan="13" style="text-align:right;">Carry-forwarded from page $f: </td>
              <td colspan="1" style="text-align:right;"></td>
              <td  colspan="2" style="text-align:center; background-color: ;">Rs. $total</td>
              </tr>
              EOD;
              $f++;  
            }
           ...
           // $diss=number_format((float)$dis, 2, '.', ''); 
            ...
            <td colspan="1" style="text-align:right;"></td>
            <td  colspan="2" style="text-align:center; background-color:  ">Rs. $amtt</td>
            </tr>
            <tr>
            <td colspan="13" style="text-align:right;">10% discount: </td>
            <td colspan="1" style="text-align:right;"></td>
            <td  colspan="2" style="text-align:center; background-color:  ">-Rs. $dis</td>
            </tr>
            <tr>
            <td colspan="13" style="text-align:right;">Net amount payable: </td>
            <td colspan="1" style="text-align:right;"></td>
            <td  colspan="2" style="text-align:center; background-color: ;">Rs. $diss</td>
            </tr>
            </table>
            EOD;
...
//$pdf->Cell(0, 0, '', 0, 1);
//$pdf->write1DBarcode('0123456789', 'C128A', '','', '', 18, 0.4, $style, 'N');
 ...
 // $pdf->Cell(0,15,'Civil lines, Delhi',0,1,'C',0,'',false,'M','M');
            ...
            $pdf->write1DBarcode($code, 'C128A', '','', '', 18, 0.4, $style, 'N');
