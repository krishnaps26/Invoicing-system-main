...
<?php
       ...
       // $cid=$_POST['cid'];
        ...
        // $cid=$_GET['cid'];
         ...
         echo $row['price'];
         echo "</td><td>";
         echo '<a href="order21.php?pid='.$row['pid'].'&cid='.$cid.'&oid=0" class="btn btn-primary" style="background-color: #5d2a42;  border: 0; margin-left: 5px;  padding-right: 30px; padding-left: 30px;  margin-right: 5px; " id="myAnchor">Add</a>
         </td></tr>';
         $pid=$row['pid'];
       ...
       echo '     <center>
              <button type="submit" name="update" class="btn btn-primary" style="background-color: #5d2a42; border: 0; margin-bottom: 20px; margin-top: 10px;">
              <a href="invoice21.php?cid='.$cid.'" class="btn btn-primary" style="background-color: #5d2a42;  border: 0; margin-left: 5px;  padding-right: 30px; padding-left: 30px;  margin-right: 5px; " id="myAnchor">
    ...
    <?php
        ...
        while($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC)){
         ...
         echo "</td><td>";
         echo "<a href='order21.php?pid=0&cid=".$cid."&oid=".$row['oid']."' class='btn' onclick='return myFunction()' style='background-color: #5d2a42; color:white;  padding: 5px 20px;  
